#!/bin/bash
# Soruce: https://gist.github.com/maxrodrigo/b893bf76f68588766d602a57f10c4ff8?permalink_comment_id=4640883#gistcomment-4640883
#
# Usage: split-2gb-commits.sh <message>
