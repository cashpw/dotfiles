...
(defconst cashpw/location-latitude 47.5
  "Current latitude.")
(defconst cashpw/location-longitude -121.8
  "Current latitude.")
(defconst cashpw/location-name "North Bend, WA"
...
(use-package! cashpw-weather
  ...
  (cashpw-weather-latitude cashpw/location-latitude)
  (cashpw-weather-longitude cashpw/location-longitude)
  :config
  (setq
   cashpw-weather-close-window-threshold-temp 68
   cashpw-weather-open-window-threshold-temp 74)
  (when (cashpw/machine-p 'personal)
    (add-hook
     'cashpw/run-once-a-day-hooks
     (lambda () (cashpw-weather-insert-todays-open-close-window-todos
                 cashpw-weather-open-window-threshold-temp
                 cashpw-weather-close-window-threshold-temp)))))
