(custom-set-variables
 ...
 '(safe-local-variable-values
   '((eval setq-local org-capture-template--org-fc-normal
      ...
      org-capture-template--roam-todo
      ...
      (doct
       `(,org-capture-template--org-fc-cloze ,org-capture-template--org-fc-double ,org-capture-template--org-fc-normal ,org-capture-template--roam-todo))
      org-roam-directory
      (if
          (file-exists-p
     ...
     (eval progn
      ...
      (add-hook! 'before-save-hook :local #'cashweaver/org-set-last-modified)
     ...
     (eval setq-local org-default-properties
      ...
      `(("c" "concept" plain "%?" :target
         (file+head "${slug}.org" ,(string-join
                                    '("#+title: ${title}" "#+author: Cash Prokop-Weaver" "#+date: [%<%Y-%m-%d %a %H:%M>]" "#+filetags: :concept:")
                                    "
"))
         :unnarrowed t)
        ("w" "word" plain "%?" :target
         (file+head "${slug}.org" ,(string-join
                                    '("#+title: ${title}" "#+author: Cash Prokop-Weaver" "#+date: [%<%Y-%m-%d %a %H:%M>]" "#+filetags: :word:")
                                    "
"))
         :unnarrowed t)
        ("p" "person" plain "%?" :target
...
"))
        ...
        ("r" "recipe" plain "%?" :target
         (file+head "${slug}.org" ,(string-join
                                    '("#+title: ${title}" "#+author: Cash Prokop-Weaver" "#+date: [%<%Y-%m-%d %a %H:%M>]" "#+filetags: :recipe:" "
...
"))
        ...
        ("i" "ingredient" plain "%?" :target
         (file+head "${slug}.org" ,(string-join
                                    '("#+title: ${title}" "#+author: Cash Prokop-Weaver" "#+date: [%<%Y-%m-%d %a %H:%M>]" "#+filetags: :ingredient:" "
" "* TODO [#2] Ingredients" "* TODO [#2] Steps")
                                    "
"))
         :unnarrowed t))
...
"))
      ...
      `(,(format "%sunread.org" org-roam-directory)
        ,(format "%sunread.org_archive" org-roam-directory)))
     (eval add-hook! 'before-save-hook :local #'cashweaver/contacts--create-birthday-reminders)
