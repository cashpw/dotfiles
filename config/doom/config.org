...
#+RESULTS:
| cashweaver.com | :base-directory | ~/proj/blog-posts/posts/ | :base-extension | org | :publishing-directory | ~/proj/cashweaver.com/content/posts/ | :publishing-function | org-pandoc-publish-to-md | :section-numbers | t | :with-toc | nil |
