...
#+RESULTS:
| free-keys | :modules | (nil) | :recipe | (:host github :repo Fuco1/free-keys) |
...
#+RESULTS:
| operate-on-number | :modules | (nil) | :recipe | (:host github :repo knu/operate-on-number.el) |
...
#+RESULTS:
| org-noter | :modules | ((:lang . org) (:private . config) (:private . modules)) | :pin | 9ead81d42dd4dd5074782d239b2efddf9b8b7b3d | :recipe | (:host github :repo cashwever/org-noter) |
...
#+RESULTS:
| ol-notmuch | :modules | (nil) | :recipe | (:local-repo /usr/local/google/home/cashweaver/third_party/org-mode/contrib/lisp :files (ol-notmuch.el)) |
