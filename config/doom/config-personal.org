...
(defun cashpw/org-append-archive-files (file-paths)
  "Return combined list of FILE-PATHS and archives of those paths."
  (append
   file-paths
   (remove
    nil
...
#+RESULTS:
: cashpw/org-append-archive-files
...
#+RESULTS:
: cashpw/org-get-filetags-in-file
...
#+RESULTS:
: cashpw/org-roam-files-with-tags
  ...
  (let ((files (cond
                ...
                ((equal context 'people)
                 (let* ((org-roam-directory cashpw/path--notes-dir)
                        (org-roam-db-location (expand-file-name "org-roam.db"
                                                                org-roam-directory)))
                   (cashpw/org-roam-files-with-tags "hastodo" "person"))))))
    (if include-archive
        (cashpw/org-append-archive-files files)
      files)))
...
(defun cashpw/org-agenda-view--review--files-fn ()
  ...
  (append
   ...
   (cashpw/org-agenda-files 'notes-all t)))
...
#+RESULTS:
| alltodo |   | ((org-agenda-overriding-header ) (org-agenda-dim-blocked-tasks nil) (org-agenda-inhibit-startup t) (org-agenda-use-tag-inheritance nil) (org-agenda-ignore-properties '(effort appt category stats)) (org-agenda-files (seq-difference (cashpw/org-roam-todo-files) `(,(s-lex-format ${org-roam-directory}/reading_list.org) ,(s-lex-format ${org-roam-directory}/todos.org)))) (org-super-agenda-groups `((:name In Progress :todo INPROGRESS) (:auto-map cashpw/org-super-agenda--get-priority)))) |
