...
#+RESULTS:
| (lambda nil (string= org-state KILL)) | cashweaver/org-mode--done-in-cut-file-p | cashweaver/org-mode--has-cut-tag-p |
...
** =org-roam= save all files

#+begin_src emacs-lisp

(defun cashweaver/org-roam-save-all-files (dir-path)
  "TODO."
  (let (org-roam-directory
        directory)
    (mapcar
