...
(defun cashweaver/org-fc-index--remove-suspended2 (index)
  "Remove suspended positions from INDEX"
  (--filter
   (not (plist-get it :suspended))
   index))
...
;; (prin1-to-string (nth 0 (org-fc-index-filter-due (org-fc-index org-fc-context-all))))
;; (length (org-fc-index-filter-due (org-fc-index org-fc-context-all)))
(length (org-fc-index org-fc-context-all))
(length (cashweaver/org-fc-index--remove-suspended
         (org-fc-index-filter-due
          (org-fc-index org-fc-context-all))))
(length (cashweaver/org-fc-index--to-cards
         (cashweaver/org-fc-index--remove-suspended
          (org-fc-index org-fc-context-all))))
;;(nth 0 (cashweaver/org-fc-index--to-cards
         ;;(cashweaver/org-fc-index--remove-suspended
          ;;(org-fc-index org-fc-context-all))))
#+end_src
