:PROPERTIES:
:LAST_MODIFIED: [2024-09-10 Tue 08:13]
:END:
...
This is my Emacs configuration file; written in [[https://orgmode.org][=org-mode=]] in literate programming. It's based on the work of others[fn:1]. I build on top of [[github:doomemacs/doomemacs][doomemacs]]. There are others (for example: [[github:SystemCrafters/crafted-emacs][crafted-emacs]], [[github:rougier/nano-emacs][nano]], [[github:bbatsov/prelude][prelude]], [[https://sr.ht/~ashton314/emacs-bedrock/][bedrock]], and [[github:syl20bnr/spacemacs][spacemacs]]). I expect I'll migrate to a more minimal configuration over time. For now, however, =doomemacs= (1) handles all the details I don't want to worry about and (2) has a community that'll find and and fix bugs that I would otherwise have to fix on my own.
...
** =init.el=
:PROPERTIES:
:ID:       c3d59127-e33c-4849-9708-74548f6ffc5c
:END:
...
*** Input
:PROPERTIES:
:ID:       135db3bb-1e3d-4137-b2c9-8dfb2c4f5f6c
:END:
...
*** Completion
:PROPERTIES:
:ID:       3e76f9ee-fc49-43a8-962d-60c94260ed8e
:END:
...
*** User interface (UI)
:PROPERTIES:
:ID:       10761f2c-8a11-4389-9f4c-d78600245d56
:END:
...
*** Editor
:PROPERTIES:
:ID:       33094389-dfb6-4edf-9aa2-bb4d2834924a
:END:
...
*** Emacs
:PROPERTIES:
:ID:       c5efa0af-faa4-4a3b-a623-4c07003926a6
:END:
...
*** Lisp
:PROPERTIES:
:ID:       746ab23b-49f6-4334-9281-55c8586150fe
:END:
...
*** Checkers
:PROPERTIES:
:ID:       d50a8f01-4895-4ade-bd6f-82922d135824
:END:
...
(:if (not (cashpw/machine-p 'personal-phone) pdf))               ; pdf enhancements
...
*** Operating system (OS)
:PROPERTIES:
:ID:       95508927-db26-4f1e-8c6d-ee4d894ff9f6
:END:
...
*** Languages
:PROPERTIES:
:ID:       993ce95a-3771-4831-983a-d526b06fe00c
:END:
...
*** Email
:PROPERTIES:
:ID:       a5fe6324-62bb-40e5-ae62-0c3ead080fe8
:END:
...
*** Applications
:PROPERTIES:
:ID:       0a8e4124-a48a-42b4-869e-06ee26d4ff99
:END:
...
*** Configuration
:PROPERTIES:
:ID:       12e35ea1-2bf6-4ce3-9584-23cb4d8b8130
:END:
...
****** Overrides
:PROPERTIES:
:ID:       fc802a57-4eda-415f-b7f7-bcbc86b7ce3d
:END:

Issue: Decrypt prompt disappears before I can type in the password.
